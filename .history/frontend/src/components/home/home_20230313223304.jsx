...
const Home = () =>{
    ...
    return(
        ...
        <Typography variant="h3"> KUCH TO LIKHUNGI</Typography>

        <div className="homeYoutubeWrapper">
            <YoutubeCard image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzvGSX3gJcyWlYooizsDmIfIJqvPjsn5FSRw&usqp=CAU" title = "sample video" />
        </div>
        </div>
    </div>
    );
