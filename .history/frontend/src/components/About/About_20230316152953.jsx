    ...
    <div className="about" >
        ...
        <div className="aboutContainer2">
            <div>
                ...
                <Typography variant="h6" style={{ margin: "1vmax 0" }}>I am currently a second-year Btech student studying Computer Science Engineering at VIT Bhoapl University.</Typography>
